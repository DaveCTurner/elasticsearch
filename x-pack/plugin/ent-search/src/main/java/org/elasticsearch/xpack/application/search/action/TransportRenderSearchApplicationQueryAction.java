...
public class TransportRenderSearchApplicationQueryAction extends HandledTransportAction<
    ...
    protected void doExecute(
        ...
        systemIndexService.getSearchApplication(request.name(), listener.wrapMap(searchApplication -> {
            ...
            return new RenderSearchApplicationQueryAction.Response(request.name(), sourceBuilder);
        }));
    }
}
