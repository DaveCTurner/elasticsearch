...
public class TransportXPackInfoActionTests extends ESTestCase {
    ...
    public void testDoExecute() throws Exception {
        ...
        Map<UnnecessaryActionTypeSubclass<XPackInfoFeatureResponse>, FeatureSet> featureSets = new HashMap<>();
        int featureSetCount = randomIntBetween(0, 5);
        for (UnnecessaryActionTypeSubclass<XPackInfoFeatureResponse> infoAction : randomSubsetOf(featureSetCount, XPackInfoFeatureAction.ALL)) {
