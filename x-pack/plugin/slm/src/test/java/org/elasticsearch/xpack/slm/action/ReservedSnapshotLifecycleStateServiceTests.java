...
public class ReservedSnapshotLifecycleStateServiceTests extends ESTestCase {
    ...
    public void testDeleteSLMReservedStateHandler() {
        ...
        var request = new DeleteSnapshotLifecycleAction.Request(masterNodeTimeout, "daily-snapshots1");
    ...
    public void testPutSLMReservedStateHandler() throws Exception {
        ...
        try (XContentParser parser = XContentType.JSON.xContent().createParser(XContentParserConfiguration.EMPTY, json)) {
            var request = PutSnapshotLifecycleAction.Request.parseRequest(masterNodeTimeout, "daily-snapshots", parser);
