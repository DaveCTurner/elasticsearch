...
public class FrozenIndexIT extends ESIntegTestCase {
    ...
    public void testTimestampRangeRecalculatedOnStalePrimaryAllocation() throws IOException {
        ...
        ClusterRerouteUtils.doReroute(client(), new CancelAllocationCommand("index", 0, nodeNames.get(0), true));
        ...
        ClusterRerouteUtils.doReroute(client(), new AllocateStalePrimaryAllocationCommand("index", 0, nodeNames.get(0), true));
