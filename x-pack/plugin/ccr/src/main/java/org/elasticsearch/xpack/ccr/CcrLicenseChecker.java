            ...
            return new RemoteClusterClient() {
                ...
                public <Request extends TransportRequest, Response extends TransportResponse> void execute(
                    ...
                    ClientHelper.executeWithHeadersAsync(
                        ...
                        request,
                        listener,
                        (r, l) -> client.execute(actionName, r, responseReader, l)
                    );
                }
            };
        }
        ...
        return new RemoteClusterClient() {
            ...
            public <Request extends TransportRequest, Response extends TransportResponse> void execute(
                ...
                try (ThreadContext.StoredContext ignore = threadContext.stashContext()) {
                    ...
                    delegate.execute(actionName, request, responseReader, new ContextPreservingActionListener<>(supplier, listener));
                }
            }
        };
    }
