...
public class SearchableSnapshotsBlobStoreCacheIntegTests extends BaseFrozenSearchableSnapshotsIntegTestCase {
    ...
    public void testBlobStoreCache() throws Exception {
        ...
        expectThrows(
            ...
            () -> systemClient().admin().indices().prepareGetIndex(masterNodeTimeout).addIndices(SNAPSHOT_BLOB_CACHE_INDEX).get()
        );
        ...
        assertThat(
            systemClient().admin()
                .indices()
                .prepareGetSettings(masterNodeTimeout, SNAPSHOT_BLOB_CACHE_INDEX)
                .get()
