...
public class AutodetectProcessManagerTests extends ESTestCase {
    ...
    public void testOpenJob() {
        ...
        manager.openJob(jobTask, clusterState, TimeValue.timeValueSeconds(30), (e, b) -> {});
    ...
    public void testOpenJob_withoutVersion() {
        ...
        manager.openJob(jobTask, clusterState, TimeValue.timeValueSeconds(30), (e, b) -> errorHolder.set(e));
    ...
    public void testOpenJob_exceedMaxNumJobs() {
        ...
        manager.openJob(jobTask, clusterState, TimeValue.timeValueSeconds(30), (e, b) -> holder[0] = e);
        ...
        manager.openJob(jobTask, clusterState, TimeValue.timeValueSeconds(30), (e1, b) -> {});
        assertEquals(3, manager.numberOfOpenJobs());
    }
