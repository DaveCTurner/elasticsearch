...
public class AutodetectProcessManagerTests extends ESTestCase {
    ...
    public void testOpenJob() {
        ...
        manager.openJob(jobTask, clusterState, TRAPPY_IMPLICIT_DEFAULT_MASTER_NODE_TIMEOUT, (e, b) -> {});
    ...
    public void testOpenJob_withoutVersion() {
        ...
        manager.openJob(jobTask, clusterState, TRAPPY_IMPLICIT_DEFAULT_MASTER_NODE_TIMEOUT, (e, b) -> errorHolder.set(e));
    ...
    public void testOpenJob_exceedMaxNumJobs() {
        ...
        manager.openJob(jobTask, clusterState, TRAPPY_IMPLICIT_DEFAULT_MASTER_NODE_TIMEOUT, (e, b) -> holder[0] = e);
        ...
        manager.openJob(jobTask, clusterState, TRAPPY_IMPLICIT_DEFAULT_MASTER_NODE_TIMEOUT, (e1, b) -> {});
        assertEquals(3, manager.numberOfOpenJobs());
    }
