...
public class GceDiscoverTests extends ESIntegTestCase {
    ...
    public void testJoin() {
        ...
        assertNoTimeout(client().admin().cluster().prepareHealth(masterNodeTimeout).setWaitForNodes(Integer.toString(2)).get());
        ...
        assertNoTimeout(client().admin().cluster().prepareHealth(masterNodeTimeout).setWaitForNodes(Integer.toString(3)).get());
