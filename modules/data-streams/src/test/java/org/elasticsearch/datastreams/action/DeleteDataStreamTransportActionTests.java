...
public class DeleteDataStreamTransportActionTests extends ESTestCase {
    ...
    public void testDeleteDataStream() {
        ...
        DeleteDataStreamAction.Request req = new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { dataStreamName });
    ...
    public void testDeleteMultipleDataStreams() {
        ...
        DeleteDataStreamAction.Request req = new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { "ba*", "eggplant" });
        ClusterState newState = DeleteDataStreamTransportAction.removeDataStream(iner, cs, req, validator, Settings.EMPTY);
