...
public class SystemDataStreamSnapshotIT extends AbstractSnapshotIntegTestCase {
    ...
    public void testSystemDataStreamInGlobalState() throws Exception {
        ...
        {
            CreateDataStreamAction.Request request = new CreateDataStreamAction.Request(masterNodeTimeout, SYSTEM_DATA_STREAM_NAME);
        ...
        assertSuccessful(
            clusterAdmin().prepareCreateSnapshot(masterNodeTimeout, REPO, SNAPSHOT)
        ...
        {
            GetIndexResponse indicesRemaining = indicesAdmin().prepareGetIndex(masterNodeTimeout).addIndices("_all").get();
        ...
        try {
            clusterAdmin().prepareRestoreSnapshot(masterNodeTimeout, REPO, SNAPSHOT)
        ...
        RestoreSnapshotResponse restoreSnapshotResponse = clusterAdmin().prepareRestoreSnapshot(masterNodeTimeout, REPO, SNAPSHOT)
            .setWaitForCompletion(true)
