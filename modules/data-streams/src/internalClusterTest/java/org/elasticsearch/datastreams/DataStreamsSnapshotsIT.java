...
public class DataStreamsSnapshotsIT extends AbstractSnapshotIntegTestCase {
    ...
    public void setup() throws Exception {
        ...
        CreateDataStreamAction.Request request = new CreateDataStreamAction.Request(masterNodeTimeout, "ds");
        AcknowledgedResponse response = client.execute(CreateDataStreamAction.INSTANCE, request).get();
        assertTrue(response.isAcknowledged());

        request = new CreateDataStreamAction.Request(masterNodeTimeout, "other-ds");
    ...
    public void testSnapshotAndRestore() throws Exception {
        ...
        assertAcked(
            client.execute(DeleteDataStreamAction.INSTANCE, new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { "ds" }))
        );
        ...
        GetDataStreamAction.Response ds = client.execute(
            ...
            new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "ds" })
        ).get();
        ...
        GetAliasesResponse getAliasesResponse = client.admin()
            .indices()
            .getAliases(new GetAliasesRequest(masterNodeTimeout, "my-alias"))
            .actionGet();
    ...
    public void testSnapshotAndRestoreAllDataStreamsInPlace() throws Exception {
        ...
        GetDataStreamAction.Request getDataSteamRequest = new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "*" });
    ...
    public void testSnapshotAndRestoreInPlace() {
        ...
        GetDataStreamAction.Request getDataSteamRequest = new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "ds" });
    ...
    public void testSnapshotAndRestoreAllIncludeSpecificDataStream() throws Exception {
        ...
        assertAcked(
            client.execute(DeleteDataStreamAction.INSTANCE, new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { "*" }))
                .get()
        );
        assertAcked(
            client.admin()
        ...
        GetDataStreamAction.Response ds = client.execute(
            GetDataStreamAction.INSTANCE,
            new GetDataStreamAction.Request(masterNodeTimeout, new String[] { dataStreamToSnapshot })
        ).get();
        assertEquals(1, ds.getDataStreams().size());
        assertEquals(1, ds.getDataStreams().get(0).getDataStream().getIndices().size());
        ...
        DeleteDataStreamAction.Request r = new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { dataStreamToSnapshot });
    ...
    public void testSnapshotAndRestoreReplaceAll() throws Exception {
        ...
        GetDataStreamAction.Response ds = client.execute(
            GetDataStreamAction.INSTANCE,
            new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "*" })
        ).get();
        ...
        DeleteDataStreamAction.Request r = new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { "*" });
        assertAcked(client().execute(DeleteDataStreamAction.INSTANCE, r).get());
    }
    ...
    public void testSnapshotAndRestoreIncludeAliasesFalse() throws Exception {
        ...
        GetAliasesResponse getAliasesResponse = client.admin()
            .indices()
            .getAliases(new GetAliasesRequest(masterNodeTimeout, "*"))
            .actionGet();
    ...
    public void testRename() throws Exception {
        ...
        expectThrows(
            ...
            client.admin().cluster().prepareRestoreSnapshot(masterNodeTimeout, REPO, SNAPSHOT).setWaitForCompletion(true).setIndices("ds")
        );
        ...
        GetDataStreamAction.Response ds = client.execute(
            GetDataStreamAction.INSTANCE,
            new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "ds2" })
        ).get();
        assertEquals(1, ds.getDataStreams().size());
        assertEquals(1, ds.getDataStreams().get(0).getDataStream().getIndices().size());
    ...
    public void testRenameWriteDataStream() throws Exception {
        ...
        GetDataStreamAction.Response ds = client.execute(
            GetDataStreamAction.INSTANCE,
            new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "other-ds2" })
        ).get();
        assertEquals(1, ds.getDataStreams().size());
        assertEquals(1, ds.getDataStreams().get(0).getDataStream().getIndices().size());
    ...
    public void testBackingIndexIsNotRenamedWhenRestoringDataStream() {
        ...
        GetDataStreamAction.Request getDSRequest = new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "ds" });
    ...
    public void testDataStreamAndBackingIndicesAreRenamedUsingRegex() {
        ...
        GetDataStreamAction.Request getRenamedDS = new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "test-ds" });
    ...
    public void testWildcards() throws Exception {
        CreateSnapshotResponse createSnapshotResponse = client.admin()
            .cluster()
            .prepareCreateSnapshot(masterNodeTimeout, REPO, "snap2")
            .setWaitForCompletion(true)
            .setIndices("d*")
            .setIncludeGlobalState(false)
            .get();
        ...
        RestoreSnapshotResponse restoreSnapshotResponse = client.admin()
            .cluster()
            .prepareRestoreSnapshot(masterNodeTimeout, REPO, "snap2")
            .setWaitForCompletion(true)
            .setIndices("d*")
            .setRenamePattern("ds")
            .setRenameReplacement("ds2")
    ...
    public void testDataStreamNotStoredWhenIndexRequested() {
        ...
        expectThrows(
            Exception.class,
            client.admin().cluster().prepareRestoreSnapshot(masterNodeTimeout, REPO, "snap2").setWaitForCompletion(true).setIndices("ds")
        );
    }
    ...
    public void testDataStreamNotRestoredWhenIndexRequested() throws Exception {
        ...
        GetDataStreamAction.Request getRequest = new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "ds" });
    ...
    public void testDataStreamNotIncludedInLimitedSnapshot() throws ExecutionException, InterruptedException {
        ...
        CreateSnapshotResponse createSnapshotResponse = client.admin()
            .cluster()
            .prepareCreateSnapshot(masterNodeTimeout, REPO, snapshotName)
            .setWaitForCompletion(true)
        ...
        final RestoreSnapshotResponse restoreSnapshotResponse = clusterAdmin().prepareRestoreSnapshot(masterNodeTimeout, REPO, snapshotName)
            .get();
    ...
    public void testDeleteDataStreamDuringSnapshot() throws Exception {
        ...
        GetDataStreamAction.Request getDataStreamRequest = new GetDataStreamAction.Request(masterNodeTimeout, new String[] { dataStream });
        GetDataStreamAction.Response getDataStreamResponse = client.execute(GetDataStreamAction.INSTANCE, getDataStreamRequest).actionGet();
        ...
        ActionFuture<CreateSnapshotResponse> future = client1.admin()
            .cluster()
            .prepareCreateSnapshot(masterNodeTimeout, repositoryName, SNAPSHOT)
        ...
        try {
            ...
            client1.execute(
                ...
                new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { dataStream })
            ).actionGet();
    ...
    public void testCloneSnapshotThatIncludesDataStream() throws Exception {
        ...
        assertSuccessful(
            client.admin()
                .cluster()
                .prepareCreateSnapshot(masterNodeTimeout, REPO, sourceSnapshotName)
                .setWaitForCompletion(true)
        ...
        assertAcked(
            clusterAdmin().prepareCloneSnapshot(masterNodeTimeout, REPO, sourceSnapshotName, "target-snapshot-1")
    ...
    public void testSnapshotDSDuringRollover() throws Exception {
        ...
        RestoreInfo restoreSnapshotResponse = clusterAdmin().prepareRestoreSnapshot(masterNodeTimeout, repoName, snapshotName)
            .setWaitForCompletion(true)
            .setIndices("ds")
            .get()
            .getRestoreInfo();
    ...
    public void testSnapshotDSDuringRolloverAndDeleteOldIndex() throws Exception {
        ...
        assertAcked(
            client().execute(
                DeleteDataStreamAction.INSTANCE,
                new DeleteDataStreamAction.Request(masterNodeTimeout, new String[] { "other-ds" })
            )
        );
    ...
    public void testRestoreSnapshotFully() throws Exception {
        ...
        RestoreSnapshotResponse restoreSnapshotResponse = client.admin()
            .cluster()
            .prepareRestoreSnapshot(masterNodeTimeout, REPO, snapshotName)
            .setWaitForCompletion(true)
            .get();
        assertEquals(RestStatus.OK, restoreSnapshotResponse.status());

        GetDataStreamAction.Request getRequest = new GetDataStreamAction.Request(masterNodeTimeout, new String[] { "*" });
    ...
    public void testRestoreDataStreamAliasWithConflictingDataStream() throws Exception {
        ...
        try {
            ...
            var e = expectThrows(
                ...
                client.admin().cluster().prepareRestoreSnapshot(masterNodeTimeout, REPO, snapshotName).setWaitForCompletion(true)
            );
