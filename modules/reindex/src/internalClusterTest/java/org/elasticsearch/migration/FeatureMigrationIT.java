...
public class FeatureMigrationIT extends AbstractFeatureMigrationIntegTest {
    ...
    public void testMigrateInternalManagedSystemIndex() throws Exception {
        ...
        Metadata finalMetadata = clusterAdmin().prepareState(masterNodeTimeout).get().getState().metadata();
    ...
    public void testMigrateIndexWithWriteBlock() throws Exception {
        ...
        client().execute(PostFeatureUpgradeAction.INSTANCE, new PostFeatureUpgradeRequest(masterNodeTimeout)).get();
    ...
    private void migrateWithTemplatesV1(String templatePrefix, SystemIndexDescriptor... descriptors) throws Exception {
        ...
        indicesAdmin().preparePutTemplate(masterNodeTimeout, "bad_template")
        ...
        PostFeatureUpgradeResponse migrationResponse = client().execute(
            ...
            new PostFeatureUpgradeRequest(masterNodeTimeout)
        ).get();
    ...
    private void migrateWithTemplatesV2(String prefix, SystemIndexDescriptor... descriptors) throws Exception {
        ...
        client().execute(
            ...
            new PutComponentTemplateAction.Request(masterNodeTimeout, "a-ct").componentTemplate(ct)
        ).get();
        ...
        client().execute(
            ...
            new TransportPutComposableIndexTemplateAction.Request(masterNodeTimeout, "a-it").indexTemplate(cit)
        ).get();
