...
public class RetryTests extends ESIntegTestCase {
    ...
    private void testCase(
        ...
        indicesAdmin().prepareCreate(masterNodeTimeout, "source").setSettings(indexSettings).get();
        // Not all test cases use the dest index but those that do require that it be on the node will small thread pools
        indicesAdmin().prepareCreate(masterNodeTimeout, "dest").setSettings(indexSettings).get();
