...
license](licenses/ELASTIC-LICENSE.txt). Community contributions to this code
are welcome, and should have the following license header:
...
checks if code does not have the appropriate license headers.

You may find it helpful to configure your IDE to automatically insert the
appropriate license header depending on the part of the project to which you
are contributing.
