...
public class RedirectToLocalClusterRemoteClusterClient implements RemoteClusterClient {
    ...
    @Override
    public <Request extends TransportRequest, Response extends ActionResponse> void execute(
        ActionType<Response> action,
        Request request,
        ActionListener<Response> listener
    ) {
        delegate.execute(action, (ActionRequest) request, listener);
    }
    ...
    public <Request extends TransportRequest, Response extends TransportResponse> void execute(
        ...
        throw new AssertionError("cannot use RedirectToLocalClusterRemoteClusterClient with transport requests");
    }
}
