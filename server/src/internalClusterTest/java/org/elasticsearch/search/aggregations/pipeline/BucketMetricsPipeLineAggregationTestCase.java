...
abstract class BucketMetricsPipeLineAggregationTestCase<T extends InternalNumericMetricsAggregation> extends ESIntegTestCase {
    ...
    public void setupSuiteScopeCluster() throws Exception {
        assertAcked(indicesAdmin().prepareCreate(masterNodeTimeout, "idx").setMapping("tag", "type=keyword").get());
    ...
    public void testFieldIsntWrittenOutTwice() throws Exception {
        ...
        XContentBuilder builder = jsonBuilder().startObject()
          ...
          .endObject();
        // end::noformat
        assertAcked(indicesAdmin().prepareCreate(masterNodeTimeout, "foo_2").setMapping(builder).get());
        // tag::noformat
