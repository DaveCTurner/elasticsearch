...
public class InternalSettingsIT extends ESIntegTestCase {
    ...
    public void testSetInternalIndexSettingOnCreate() {
        ...
        final GetSettingsResponse response = indicesAdmin().prepareGetSettings(masterNodeTimeout, "index").get();
    ...
    public void testUpdateInternalIndexSettingViaSettingsAPI() {
        ...
        final GetSettingsResponse responseAfterAttemptedUpdate = indicesAdmin().prepareGetSettings(masterNodeTimeout, "test").get();
    ...
    public void testUpdateInternalIndexSettingViaDedicatedAPI() {
        ...
        final GetSettingsResponse responseAfterUpdate = indicesAdmin().prepareGetSettings(masterNodeTimeout, "test").get();
