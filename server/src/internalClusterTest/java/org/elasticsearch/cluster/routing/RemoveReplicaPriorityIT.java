...
public class RemoveReplicaPriorityIT extends ESIntegTestCase {
    ...
    public void testReplicaRemovalPriority() throws Exception {
        ...
        final String dataNodeIdFilter = clusterAdmin().prepareState(masterNodeTimeout)
            .clear()
            .setNodes(true)
            .get()
            .getState()
        ...
        assertBusy(() -> {
            final IndexShardRoutingTable indexShardRoutingTable = clusterAdmin().prepareState(masterNodeTimeout)
                .clear()
