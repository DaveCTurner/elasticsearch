...
public class MockDiskUsagesIT extends ESIntegTestCase {
    ...
    public void testRerouteOccursOnDiskPassingHighWatermark() throws Exception {
        ...
        final List<String> nodeIds = clusterAdmin().prepareState(masterNodeTimeout)
            .get()
            .getState()
            .getRoutingNodes()
            .stream()
    ...
    public void testAutomaticReleaseOfIndexBlock() throws Exception {
        ...
        assertFalse(clusterAdmin().prepareHealth(masterNodeTimeout, "test").setWaitForEvents(Priority.LANGUID).get().isTimedOut());
