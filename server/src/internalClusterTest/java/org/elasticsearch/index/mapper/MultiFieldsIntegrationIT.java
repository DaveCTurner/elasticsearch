...
public class MultiFieldsIntegrationIT extends ESIntegTestCase {
    ...
    public void testMultiFields() throws Exception {
        ...
        GetMappingsResponse getMappingsResponse = indicesAdmin().prepareGetMappings(masterNodeTimeout, "my-index").get();
        ...
        getMappingsResponse = indicesAdmin().prepareGetMappings(masterNodeTimeout, "my-index").get();
