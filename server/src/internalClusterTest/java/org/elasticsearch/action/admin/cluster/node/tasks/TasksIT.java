...
public class TasksIT extends ESIntegTestCase {
    ...
    public void testMasterNodeOperationTasks() throws Exception {
        ...
        internalCluster().masterClient().admin().cluster().prepareHealth(masterNodeTimeout).get();
        ...
        internalCluster().nonMasterClient().admin().cluster().prepareHealth(masterNodeTimeout).get();
