...
public class RepositoryBlocksIT extends ESIntegTestCase {
    ...
    public void testVerifyRepositoryWithBlocks() {
        ...
        try {
            setClusterReadOnly(true);
            VerifyRepositoryResponse response = clusterAdmin().prepareVerifyRepository(masterNodeTimeout, "test-repo-blocks").get();
    ...
    public void testGetRepositoryWithBlocks() {
        ...
        try {
            setClusterReadOnly(true);
            GetRepositoriesResponse response = clusterAdmin().prepareGetRepositories(masterNodeTimeout, "test-repo-blocks").get();
