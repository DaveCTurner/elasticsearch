...
public class ResolvedRepositoriesTests extends ESTestCase {
    ...
    private static void runMatchAllTest(String... patterns) {
        ...
        assertEquals(RepositoriesMetadata.get(state).repositories(), result.metadata());
    ...
    public void testMatchingName() {
        ...
        assertEquals(List.of(RepositoriesMetadata.get(state).repository(name)), result.metadata());
        assertThat(result.missing(), Matchers.empty());
        assertFalse(result.hasMissingRepositories());
    }
    ...
    public void testMismatchingName() {
        ...
        assertEquals(List.of(), result.metadata());
    ...
    private static void runWildcardTest(ClusterState clusterState, Set<String> expectedNames, String... patterns) {
        ...
        assertEquals(description, expectedNames, result.metadata().stream().map(RepositoryMetadata::name).collect(Collectors.toSet()));
    }
