...
public class MetadataIndexTemplateServiceTests extends ESSingleNodeTestCase {
    ...
    public void testIndexTemplateWithAlias() throws Exception {
        ...
        final Metadata metadata = clusterAdmin().prepareState(masterNodeTimeout).get().getState().metadata();
    ...
    public void testFindTemplates() throws Exception {
        client().admin().indices().prepareDeleteTemplate(masterNodeTimeout, "*").get(); // Delete all existing templates
