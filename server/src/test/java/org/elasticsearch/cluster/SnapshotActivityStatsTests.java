...
public class SnapshotActivityStatsTests extends AbstractWireSerializingTestCase<SnapshotActivityStats> {

    @Override
    protected Writeable.Reader<SnapshotActivityStats> instanceReader() {
        return SnapshotActivityStats::readFrom;
    }
    ...
    @Override
    protected SnapshotActivityStats createTestInstance() {
        return new SnapshotActivityStats(
            randomNonNegativeInt(),
            randomNonNegativeInt(),
            randomNonNegativeInt(),
            randomList(0, 10, SnapshotActivityStatsTests::createRepositoryStats)
        );
    }

    @Override
    protected SnapshotActivityStats mutateInstance(SnapshotActivityStats instance) throws IOException {
        return switch (between(1, 4)) {
            case 1 -> new SnapshotActivityStats(
    ...
    private static List<SnapshotActivityStats.SnapshotRepositoryActivityStats> mutatePerRepositoryStats(
        List<SnapshotActivityStats.SnapshotRepositoryActivityStats> statsByRepository
    ) {
    ...
    private static SnapshotActivityStats.SnapshotRepositoryActivityStats createRepositoryStats() {
        return new SnapshotActivityStats.SnapshotRepositoryActivityStats(
    ...
    private static SnapshotActivityStats.SnapshotRepositoryActivityStats mutateRepositoryStats(
        SnapshotActivityStats.SnapshotRepositoryActivityStats instance
    ) {
        return switch (between(1, 12)) {
            case 1 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
            ...
            case 2 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
            ...
            case 3 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
            ...
            case 4 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
            ...
            case 5 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
            ...
            case 6 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
            ...
            case 7 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
            ...
            case 8 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
            ...
            case 9 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
            ...
            case 10 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
            ...
            case 11 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
            ...
            case 12 -> new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                instance.repositoryName(),
                instance.repositoryType(),
                instance.snapshotCount(),
                instance.cloneCount(),
    ...
    public void testEmpty() {
        assertEquals(SnapshotActivityStats.EMPTY, SnapshotActivityStats.of(ClusterState.EMPTY_STATE, randomNonNegativeLong()));
    }
    ...
    public void testComputation() {
        ...
        assertEquals(
            new SnapshotActivityStats(
                2,
                1,
                1,
                List.of(
                    new SnapshotActivityStats.SnapshotRepositoryActivityStats(
                        "test-repo",
                        "test-repo-type",
                        1,
                        1,
