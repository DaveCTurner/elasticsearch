...
public class ScriptServiceTests extends ESTestCase {
    ...
    public void testGetStoredScript() throws Exception {
        ...
        assertEquals("abc", ScriptService.getStoredScript(cs, new GetStoredScriptRequest(masterNodeTimeout, "_id")).getSource());

        cs = ClusterState.builder(new ClusterName("_name")).build();
        assertNull(ScriptService.getStoredScript(cs, new GetStoredScriptRequest(masterNodeTimeout, "_id")));
    }
