...
public class IndicesServiceTests extends ESSingleNodeTestCase {
    ...
    public void testDanglingIndicesWithAliasConflict() throws Exception {
        ...
        client().admin().indices().prepareAliases(masterNodeTimeout).addAlias(indexName, alias).get();
        ...
        // remove the alias
        client().admin().indices().prepareAliases(masterNodeTimeout).removeAlias(indexName, alias).get();
