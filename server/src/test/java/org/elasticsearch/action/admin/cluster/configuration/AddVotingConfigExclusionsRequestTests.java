...
public class AddVotingConfigExclusionsRequestTests extends ESTestCase {
    ...
    public void testSerializationForNodeIdOrNodeName() throws IOException {
        ...
        originalRequest = new AddVotingConfigExclusionsRequest(masterNodeTimeout, "nodeName1", "nodeName2");
    ...
    public void testResolve() {
        ...
        assertThat(
            new AddVotingConfigExclusionsRequest(masterNodeTimeout, "local", "other1", "other2").resolveVotingConfigExclusions(
                clusterState
            ),
            containsInAnyOrder(localNodeExclusion, otherNode1Exclusion, otherNode2Exclusion)
        );
        assertThat(
            new AddVotingConfigExclusionsRequest(masterNodeTimeout, "local").resolveVotingConfigExclusions(clusterState),
            contains(localNodeExclusion)
        );
        assertThat(
            new AddVotingConfigExclusionsRequest(masterNodeTimeout, "other1", "other2").resolveVotingConfigExclusions(clusterState),
    ...
    public void testResolveAllNodeIdentifiersNullOrEmpty() {
        assertThat(
            expectThrows(
                ...
                () -> new AddVotingConfigExclusionsRequest(masterNodeTimeout, Strings.EMPTY_ARRAY, Strings.EMPTY_ARRAY, TimeValue.ZERO)
            ).getMessage(),
    ...
    public void testResolveByNodeNames() {
        ...
        assertThat(
            new AddVotingConfigExclusionsRequest(masterNodeTimeout, "nodeName1", "nodeName2").resolveVotingConfigExclusions(clusterState),
            containsInAnyOrder(node1Exclusion, node2Exclusion)
        );

        assertThat(
            new AddVotingConfigExclusionsRequest(masterNodeTimeout, "nodeName1", "unresolvableNodeName").resolveVotingConfigExclusions(
                clusterState
            ),
            containsInAnyOrder(node1Exclusion, unresolvableVotingConfigExclusion)
        );
    ...
    public void testResolveAmbiguousName() {
        ...
        final var request = new AddVotingConfigExclusionsRequest(masterNodeTimeout, "ambiguous-name");
        assertThat(
    ...
    public void testResolveAndCheckMaximum() {
        ...
        assertThat(
            new AddVotingConfigExclusionsRequest(masterNodeTimeout, "local").resolveVotingConfigExclusionsAndCheckMaximum(
                clusterState,
                2,
                "setting.name"
            ),
