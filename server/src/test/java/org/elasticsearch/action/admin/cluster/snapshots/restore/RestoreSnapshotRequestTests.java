...
public class RestoreSnapshotRequestTests extends AbstractWireSerializingTestCase<RestoreSnapshotRequest> {
    ...
    protected RestoreSnapshotRequest createTestInstance() {
        return randomState(new RestoreSnapshotRequest(masterNodeTimeout, randomAlphaOfLength(5), randomAlphaOfLength(10)));
    }
    ...
    public void testSource() throws IOException {
        ...
        RestoreSnapshotRequest processed = new RestoreSnapshotRequest(masterNodeTimeout, original.repository(), original.snapshot());
