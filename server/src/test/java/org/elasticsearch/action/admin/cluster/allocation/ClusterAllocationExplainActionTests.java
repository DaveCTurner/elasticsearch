...
public class ClusterAllocationExplainActionTests extends ESTestCase {
    ...
    public void testFindAnyUnassignedShardToExplain() {
        ...
        ClusterAllocationExplainRequest request = new ClusterAllocationExplainRequest(masterNodeTimeout);
        ...
        request = new ClusterAllocationExplainRequest(masterNodeTimeout);
        ...
        final ClusterAllocationExplainRequest anyUnassignedShardsRequest = new ClusterAllocationExplainRequest(masterNodeTimeout);
        assertThat(
            expectThrows(
    ...
    public void testFindPrimaryShardToExplain() {
        ...
        ClusterAllocationExplainRequest request = new ClusterAllocationExplainRequest(masterNodeTimeout, "idx", 0, true, null);
        ShardRouting shard = findShardToExplain(request, routingAllocation(clusterState));
        assertEquals(clusterState.getRoutingTable().index("idx").shard(0).primaryShard(), shard);
    }
    ...
    public void testFindAnyReplicaToExplain() {
        ...
        ClusterAllocationExplainRequest request = new ClusterAllocationExplainRequest(masterNodeTimeout, "idx", 0, false, null);
        ShardRouting shard = findShardToExplain(request, routingAllocation(clusterState));
        assertEquals(
        ...
        request = new ClusterAllocationExplainRequest(masterNodeTimeout, "idx", 0, false, null);
        shard = findShardToExplain(request, routingAllocation(clusterState));
        assertEquals(
