...
public class PrevalidateNodeRemovalRequestTests extends ESTestCase {
    ...
    public void testValidate() {
        ActionRequestValidationException ex1 = PrevalidateNodeRemovalRequest.builder().build(masterNodeTimeout).validate();
        assertNotNull(ex1);
        ...
        assertNull(PrevalidateNodeRemovalRequest.builder().setNames("name1").build(masterNodeTimeout).validate());
        assertNull(PrevalidateNodeRemovalRequest.builder().setIds("id1").build(masterNodeTimeout).validate());
        assertNull(PrevalidateNodeRemovalRequest.builder().setExternalIds("external_id1").build(masterNodeTimeout).validate());
    }
}
