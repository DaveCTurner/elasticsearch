...
public class TransportDeleteDesiredBalanceActionTests extends ESAllocationTestCase {
    ...
    public void testReturnsErrorIfAllocatorIsNotDesiredBalanced() throws Exception {
        ...
        ).masterOperation(mock(Task.class), new DesiredBalanceRequest(masterNodeTimeout), ClusterState.EMPTY_STATE, listener);
    ...
    public void testDeleteDesiredBalance() throws Exception {
        ...
        action.masterOperation(mock(Task.class), new DesiredBalanceRequest(masterNodeTimeout), clusterState, listener);
