...
public class TransportNodesActionTests extends ESTestCase {
    ...
    private static class TestNodeResponse extends BaseNodeResponse {
        ...
        private final SubscribableListener<Void> onCloseListener = new SubscribableListener<>();
        private final RefCounted refCounted = AbstractRefCounted.of(() -> onCloseListener.onResponse(null));
        ...
        void addCloseListener(ActionListener<Void> listener) {
            onCloseListener.addListener(listener);
        }
    }
