...
public class InternalEngineSettingsTests extends ESSingleNodeTestCase {
    ...
    public void testSettingsUpdate() {
        ...
        for (int i = 0; i < iters; i++) {
            ...
            indicesAdmin().prepareUpdateSettings(masterNodeTimeout, "foo").setSettings(build).get();
        ...
        indicesAdmin().prepareUpdateSettings(masterNodeTimeout, "foo").setSettings(settings).get();
