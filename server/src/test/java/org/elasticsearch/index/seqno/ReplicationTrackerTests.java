...
public class ReplicationTrackerTests extends ReplicationTrackerTestCase {
    ...
    public void testGlobalCheckpointUpdate() {
        ...
        tracker.activatePrimaryMode(NO_OPS_PERFORMED, 0L);
    ...
    public void testMarkAllocationIdAsInSync() throws BrokenBarrierException, InterruptedException {
        ...
        tracker.activatePrimaryMode(localCheckpoint, 0L);
    ...
    public void testWaitForAllocationIdToBeInSync() throws Exception {
        ...
        tracker.activatePrimaryMode(globalCheckpoint, 0L);
        final Thread thread = new Thread(() -> {
            try {
    ...
    public void testRaceUpdatingGlobalCheckpoint() throws InterruptedException, BrokenBarrierException {
        ...
        tracker.updateFromMaster(
                ...
                emptySet());
        tracker.activatePrimaryMode(activeLocalCheckpoint, 0L);
