 ...
 */
public class LagDetector extends AbstractComponent {
    // TODO integrate this more tightly with the acking mechanism?
    // TODO allow other components to wait for nodes to apply a state using the tracking done here?
    ...
    Set<DiscoveryNode> getTrackedNodes() {
        return appliedStateTrackersByNode.keySet();
    }
