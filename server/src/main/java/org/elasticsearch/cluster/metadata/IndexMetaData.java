...
public class IndexMetaData implements Diffable<IndexMetaData>, ToXContentFragment {
    ...
    public static final Setting<String> SETTING_AUTOGENERATED_ID_FORMAT =
        Setting.simpleString("index.autogenerated_id_format", Property.IndexScope, Property.Dynamic);
    ...
    private final UUIDGenerator autogeneratedIdGenerator;
    ...
    private IndexMetaData(Index index, long version, long[] primaryTerms, State state, int numberOfShards, int numberOfReplicas, Settings settings,
        ...
        this.autogeneratedIdGenerator = UUIDs.getUUIDGenerator(SETTING_AUTOGENERATED_ID_FORMAT.get(settings));
    ...
    public UUIDGenerator getUUIDGenerator() {
        return autogeneratedIdGenerator;
    }
