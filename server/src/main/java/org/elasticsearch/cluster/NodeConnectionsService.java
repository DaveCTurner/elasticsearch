 ...
 * are unresponsive: this is the job of the master's fault detection components, particularly {@link NodesFaultDetection}.
 * <p>
...
public class NodeConnectionsService extends AbstractLifecycleComponent {
    ...
    class ConnectionChecker extends AbstractRunnable {
        ...
        void scheduleNextCheck() {
            if (connectionChecker == this) {
                try {
                    threadPool.schedule(this, reconnectInterval, ThreadPool.Names.GENERIC);
                } catch (EsRejectedExecutionException e) {
                    if (e.isExecutorShutdown()) {
                        logger.debug(new ParameterizedMessage(
                            "could not schedule execution of [{}] after [{}] on [{}] as executor is shut down",
                                this, reconnectInterval, ThreadPool.Names.GENERIC), e);
                    } else {
                        throw e;
                    }
                }
