...
public class RetentionLeaseBackgroundSyncAction extends TransportReplicationAction<
    ...
    protected void shardOperationOnPrimary(
            ...
            final IndexShard primary, ActionListener<TransportRerouteFreeReplicationAction.PrimaryResult<Request, ReplicationResponse>> listener) {
        ActionListener.completeWith(listener, () -> {
            assert request.waitForActiveShards().equals(ActiveShardCount.NONE) : request.waitForActiveShards();
            Objects.requireNonNull(request);
            Objects.requireNonNull(primary);
            primary.persistRetentionLeases();
            return new TransportRerouteFreeReplicationAction.PrimaryResult<>(request, new ReplicationResponse());
        });
    }

    @Override
    protected TransportRerouteFreeReplicationAction.ReplicaResult shardOperationOnReplica(final Request request, final IndexShard replica) throws WriteStateException {
        Objects.requireNonNull(request);
