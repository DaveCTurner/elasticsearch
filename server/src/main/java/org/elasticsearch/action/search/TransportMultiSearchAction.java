...
public class TransportMultiSearchAction extends HandledTransportAction<MultiSearchRequest, MultiSearchResponse> {
    ...
    public TransportMultiSearchAction(
        ...
        super(MultiSearchAction.NAME, transportService, actionFilters, (Writeable.Reader<MultiSearchRequest>) MultiSearchRequest::new, EsExecutors.DIRECT_EXECUTOR_SERVICE);
