 ...
 */
@SuppressWarnings({"unused", "removal"}) // Response type arg is used to enable better type inference when calling Client#execute
public sealed class ActionType<Response extends ActionResponse> permits UnnecessaryActionTypeSubclass {
