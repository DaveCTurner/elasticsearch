...
public abstract class TransportRerouteFreeReplicationAction<
    ...
    void performOnReplica(ShardRouting replica, ReplicaRequest request, long primaryTerm, long globalCheckpoint,
        ...
        final TransportRerouteFreeReplicationAction.ConcreteReplicaRequest<ReplicaRequest> replicaRequest
        ...
        final ActionListenerResponseHandler<TransportRerouteFreeReplicationAction.ReplicaResponse> handler
            = new ActionListenerResponseHandler<>(listener, in -> {
            TransportRerouteFreeReplicationAction.ReplicaResponse replicaResponse
    ...
    protected static final class ConcreteReplicaRequest<R extends ReplicationRequest> extends TransportReplicationAction.ConcreteShardRequest<R> {
