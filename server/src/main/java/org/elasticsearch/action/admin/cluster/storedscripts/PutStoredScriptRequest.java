...
public class PutStoredScriptRequest extends AcknowledgedRequest<PutStoredScriptRequest> implements ToXContentFragment {
    ...
    public PutStoredScriptRequest(TimeValue masterNodeTimeout) {
        super(masterNodeTimeout);
    }

    public PutStoredScriptRequest(TimeValue masterNodeTimeout, String id, String context, BytesReference content, XContentType xContentType, StoredScriptSource source) {
        super(masterNodeTimeout);
        this.id = id;
