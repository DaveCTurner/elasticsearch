...
public class TransportFindDanglingIndexAction extends TransportNodesAction<
    ...
    public static final UnnecessaryActionTypeSubclass<FindDanglingIndexResponse> TYPE = new UnnecessaryActionTypeSubclass<>("cluster:admin/indices/dangling/find");
