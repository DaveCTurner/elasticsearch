...
public class UpdateDesiredNodesRequest extends AcknowledgedRequest<UpdateDesiredNodesRequest> {
    ...
    public UpdateDesiredNodesRequest(TimeValue masterNodeTimeout, String historyID, long version, List<DesiredNode> nodes, boolean dryRun) {
    ...
    public static UpdateDesiredNodesRequest fromXContent(
        ...
        return new UpdateDesiredNodesRequest(masterNodeTimeout, historyID, version, nodes, dryRun);
    }
