...
public class TransportVerifyShardBeforeCloseAction extends TransportReplicationAction<
    ...
    protected void shardOperationOnPrimary(final ShardRequest shardRequest, final IndexShard primary,
            ActionListener<TransportRerouteFreeReplicationAction.PrimaryResult<ShardRequest, ReplicationResponse>> listener) {
    ...
    @Override
    protected TransportRerouteFreeReplicationAction.ReplicaResult shardOperationOnReplica(final ShardRequest shardRequest, final IndexShard replica) {
