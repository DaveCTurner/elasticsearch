...
public class ElasticsearchException extends RuntimeException implements ToXContentFragment, Writeable {
    ...
    private enum ElasticsearchExceptionHandle {
        ...
        RETRY_ON_REPLICA_EXCEPTION(TransportRerouteFreeReplicationAction.RetryOnReplicaException.class,
                TransportRerouteFreeReplicationAction.RetryOnReplicaException::new, 136,
            UNKNOWN_VERSION_ADDED),
