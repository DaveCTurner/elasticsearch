...
public class DiagnosticsAction {
    ...
    private static final class AsyncAction {
        ...
        private <T extends ToXContent> ActionListener<T> newToXContentListener(String entryName, Releasable releasable) {
            ...
            return onExceptionSendJsonListener(entryName, () -> completionListener.onResponse(null)).map(response -> {
        ...
        private ActionListener<ChunkedRestResponseBodyPart> onExceptionSendJsonListener(String entryName, Releasable releasable) {
            return response.newEntryListener(entryName, releasable)
                .delegateResponse(
